...
bool bc_parse_expression_list(struct bc_parse* parse, enum bc_tok_kind terminator, struct bc_ast_expr_list* list);

bool bc_parse_expression_bp(struct bc_parse* parse, uint8_t min_bp, struct bc_ast_expr* expr);
...
bool bc_parse_switchcase(struct bc_parse* parse, struct bc_ast_switchcase* switchcase);
...
bool bc_parse_func_param(struct bc_parse* parse, struct bc_ast_func_param* param);

bool bc_parse_func(struct bc_parse* parse, struct bc_ast_func* func);

bool bc_parse_struct_item(struct bc_parse* parse, struct bc_ast_struct_item* item);

bool bc_parse_struct_decl(struct bc_parse* parse, struct bc_ast_struct* struct_);
...
bool bc_parse_top_level_item(struct bc_parse* parse, struct bc_ast_top_level* top_level);
