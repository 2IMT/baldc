...
struct bc_strv bc_tok_kind_to_strv(enum bc_tok_kind kind) {
    switch (kind) {
    case BC_TOK_ERR:
        return BC_STRV_FROM_LIT("[err]");
    case BC_TOK_EOF:
        return BC_STRV_FROM_LIT("[eof]");
    case BC_TOK_NONE:
        return BC_STRV_FROM_LIT("[none]");
    case BC_TOK_IDENT:
        return BC_STRV_FROM_LIT("identifier");
    case BC_TOK_LIT_STRING:
        return BC_STRV_FROM_LIT("string literal");
    case BC_TOK_LIT_CHARACTER:
        return BC_STRV_FROM_LIT("character literal");
    case BC_TOK_LIT_INTEGER:
        return BC_STRV_FROM_LIT("integer literal");
    case BC_TOK_LIT_BYTE:
        return BC_STRV_FROM_LIT("byte literal");
    case BC_TOK_LIT_FLOATING:
        return BC_STRV_FROM_LIT("floating literal");
    case BC_TOK_LIT_BOOLEAN:
        return BC_STRV_FROM_LIT("boolean literal");
    case BC_TOK_KW_NULL:
        return BC_STRV_FROM_LIT("null");
    case BC_TOK_KW_STRING:
        return BC_STRV_FROM_LIT("string");
    case BC_TOK_KW_CHAR:
        return BC_STRV_FROM_LIT("char");
    case BC_TOK_KW_INT:
        return BC_STRV_FROM_LIT("int");
    case BC_TOK_KW_BYTE:
        return BC_STRV_FROM_LIT("byte");
    case BC_TOK_KW_FLOAT:
        return BC_STRV_FROM_LIT("float");
    case BC_TOK_KW_BOOL:
        return BC_STRV_FROM_LIT("bool");
    case BC_TOK_KW_TUP:
        return BC_STRV_FROM_LIT("tup");
    case BC_TOK_KW_UNIT:
        return BC_STRV_FROM_LIT("unit");
    case BC_TOK_KW_IMPORT:
        return BC_STRV_FROM_LIT("import");
    case BC_TOK_KW_EXPORT:
        return BC_STRV_FROM_LIT("export");
    case BC_TOK_KW_ROOT:
        return BC_STRV_FROM_LIT("root");
    case BC_TOK_KW_SUPER:
        return BC_STRV_FROM_LIT("super");
    case BC_TOK_KW_AS:
        return BC_STRV_FROM_LIT("as");
    case BC_TOK_KW_TRYAS:
        return BC_STRV_FROM_LIT("try_as");
    case BC_TOK_KW_STRUCT:
        return BC_STRV_FROM_LIT("struct");
    case BC_TOK_KW_ENUM:
        return BC_STRV_FROM_LIT("enum");
    case BC_TOK_KW_FUNC:
        return BC_STRV_FROM_LIT("func");
    case BC_TOK_KW_TYPE:
        return BC_STRV_FROM_LIT("type");
    case BC_TOK_KW_CONST:
        return BC_STRV_FROM_LIT("const");
    case BC_TOK_KW_DEFER:
        return BC_STRV_FROM_LIT("defer");
    case BC_TOK_KW_LET:
        return BC_STRV_FROM_LIT("let");
    case BC_TOK_KW_IF:
        return BC_STRV_FROM_LIT("if");
    case BC_TOK_KW_ELIF:
        return BC_STRV_FROM_LIT("elif");
    case BC_TOK_KW_ELSE:
        return BC_STRV_FROM_LIT("else");
    case BC_TOK_KW_LOOP:
        return BC_STRV_FROM_LIT("loop");
    case BC_TOK_KW_FOR:
        return BC_STRV_FROM_LIT("for");
    case BC_TOK_KW_WHILE:
        return BC_STRV_FROM_LIT("while");
    case BC_TOK_KW_SWITCH:
        return BC_STRV_FROM_LIT("switch");
    case BC_TOK_KW_DEFAULT:
        return BC_STRV_FROM_LIT("default");
    case BC_TOK_KW_BREAK:
        return BC_STRV_FROM_LIT("break");
    case BC_TOK_KW_CONTINUE:
        return BC_STRV_FROM_LIT("continue");
    case BC_TOK_KW_RETURN:
        return BC_STRV_FROM_LIT("return");
    case BC_TOK_LPAREN:
        return BC_STRV_FROM_LIT("(");
    case BC_TOK_RPAREN:
        return BC_STRV_FROM_LIT(")");
    case BC_TOK_LBRACE:
        return BC_STRV_FROM_LIT("{");
    ...
    case BC_TOK_QUESTION:
        return BC_STRV_FROM_LIT("?");
    case BC_TOK_COUNT:
        return BC_STRV_FROM_LIT("[count]");
    }
    return BC_STRV_FROM_LIT("[invalid]");
}
